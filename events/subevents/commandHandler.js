 ...
 * @param {{channelID: string, disabledCommands: string[]}[]} obj.channel_disabled_commands
...
module.exports.run = obj => {
    ...
    const globally_disabled_commands = obj.globally_disabled_commands;
    const channel_disabled_commands = obj.channel_disabled_commands;
