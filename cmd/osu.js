        ...
        if (args[0] === 'set') {
            ...
            https.get(options, res => {
                ...
                res.on("end", () => {
                    ...
                    if (mode === 1) embed.setAuthor("Taiko Profile for " + username, "https://a.ppy.sh/" + playerinfo.user_id, "https://osu.ppy.sh/users/" + playerinfo.user_id);
                    if (mode === 2) embed.setAuthor("Catch the Beat Profile for " + username, "https://a.ppy.sh/" + playerinfo.user_id, "https://osu.ppy.sh/users/" + playerinfo.user_id);
                    if (mode === 3) embed.setAuthor("osu!mania Profile for " + username, "https://a.ppy.sh/" + playerinfo.user_id, "https://osu.ppy.sh/users/" + playerinfo.user_id);
