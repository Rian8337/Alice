...
module.exports.run = (client, message, args, maindb) => {
	...
	binddb.findOne(query, async function (err, userres) {
		if (err) {
			console.log(err);
...
module.exports.config = {
	name: "ppsubmit",
	description: "Submits plays from user's profile into the user's droid pp profile. Only allowed in bot channel and pp project channel in droid International Discord server.",
