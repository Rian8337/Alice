        ...
        switch (args[0]) {
            ...
            default: {
                ...
                pointdb.findOne(query, async (err, pres) => {
                    ...
                    if (mapinfo.favorites > 50) return message.channel.send("❎ **| I'm sorry, that beatmap has over 50 favorites!**");
