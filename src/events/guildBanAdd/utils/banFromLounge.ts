import { GuildAuditLogs, GuildAuditLogsEntry, GuildBan, User } from "discord.js";
...
export const run: EventUtil["run"] = async (_, guildBan: GuildBan) => {
    ...
    await LoungeLockManager.lock(target.id, "Banned from server", Number.POSITIVE_INFINITY, false);
};
