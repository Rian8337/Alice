...
export enum coinsStrings {
    ...
    dailyClaimSuccess = "%s, you have %sclaimed %s\`%s\` Alice coins! Your current streak is \`%s\`. You now have %s\`%s\` Alice coins.",
    coinAmountInfo = "%s %s\`%s\` Alice coins.",
    ...
    coinTransferConfirmation = "%s, are you sure you want to transfer %s\`%s\` Alice coins to %s?",
    coinTransferFailed = "I'm sorry, I'm unable to transfer your Alice coins: %s.",
    coinTransferSuccess = "Successfully transferred %s\`%s\` Alice coins to %s. You can transfer %s\`%s\` Alice coins left today. You now have %s\`%s\` Alice coins.",
    addAmountInvalid = "Hey, I need a valid amount of coins to add!",
    addCoinSuccess = "Successfully added %s\`%s\` Alice coins to the user. The user now has %s\`%s\` Alice coins.",
    ...
    removeCoinSuccess = "Successfully remove %s\`%s\` Alice coins from user. The user now has %s\`%s\` Alice coins."
};