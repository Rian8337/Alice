...
export enum musicStrings {
    ...
    musicIsStillPlaying = "I'm sorry, there is still a music playing!",
    ...
    repeatModeSuccess = "Successfully set repeat mode to `%s`.",
    shuffleModeFailed = "I'm sorry, I couldn't modify shuffle mode: %s.",
    shuffleModeSuccess = "Successfully set shuffle mode to `%s`.",
