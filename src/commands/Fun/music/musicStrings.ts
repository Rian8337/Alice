...
export enum musicStrings {
    ...
    removeVideoFromCollectionFailed = "I'm sorry, I couldn't remove the video link in the specified position: %s.",
    removeVideoFromCollectionSuccess = "Successfully removed video link at position `%s` from collection `%s`.",
