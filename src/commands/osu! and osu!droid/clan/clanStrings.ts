...
export enum clanStrings {
    ...
    selfHasNoAdministrativePermission = "I'm sorry, you do not have enough administrative privileges in the clan to perform this action.",
    ...
    roleIconFileSizeTooBig = "I'm sorry, role icons must be less than or equal to 256 kB!",
    invalidRoleIconSize = "I'm sorry, role icons must be at least 64x64 pixels and has a 1:1 ratio!",
    ...
    removeBannerFailed = "I'm sorry, I couldn't remove the clan's banner: %s.",
