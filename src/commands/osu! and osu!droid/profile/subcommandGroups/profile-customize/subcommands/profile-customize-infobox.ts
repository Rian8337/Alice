        ...
        [
            {
                ...
                description: "View the background color of your profile card's information box."
            },
            {
                label: "Change Background Color",
                value: "changeInfoBoxBackgroundColor",
                description: "Change the background color of your profile card's information box."
            },
            {
                label: "View Text Color",
                value: "viewInfoBoxTextColor",
                description: "View the text color of your profile card's information box."
            },
            {
