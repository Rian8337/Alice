...
export enum profileStrings {
    ...
    changeInfoColorConfirmation = "%s, are you sure you want to change your profile picture description box %s color to `%s`?",
    changeInfoColorSuccess = "%s, successfully changed your profile picture description box %s color to `%s`.",
