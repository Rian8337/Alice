...
export abstract class BanManager extends PunishmentManager {
    ...
    static async ban(interaction: CommandInteraction, banned: GuildMember, reason: string): Promise<OperationResult> {
        ...
        const logChannel: GuildChannel | null = guildConfig.getGuildLogChannel(banned.guild);
    ...
    static async unban(interaction: CommandInteraction, toUnban: User, reason: string): Promise<OperationResult> {
        ...
        const logChannel: GuildChannel | null = guildConfig.getGuildLogChannel(interaction.guild!);
