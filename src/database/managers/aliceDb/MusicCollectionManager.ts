...
export class MusicCollectionManager extends DatabaseCollectionManager<DatabaseMusicCollection, MusicCollection> {
    ...
    constructor(collection: MongoDBCollection<DatabaseMusicCollection>) {
        ...
        this.utilityInstance = <DatabaseUtilityConstructor<DatabaseMusicCollection, MusicCollection>> new MusicCollection().constructor
    }
     ...
     */
    getUserCollections(user: User): Promise<DiscordCollection<string, MusicCollection>>;
     ...
     * @returns The music collections owned by the user, mapped by the name.
     */
    getUserCollections(id: Snowflake): Promise<DiscordCollection<string, MusicCollection>>;

    getUserCollections(userOrId: User | Snowflake): Promise<DiscordCollection<string, MusicCollection>> {
        return this.get("name", { owner: userOrId instanceof User ? userOrId.id : userOrId });
    }
