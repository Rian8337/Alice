...
export class OnboardingScoreComparisonENTranslation extends Translation<OnboardingScoreComparisonStrings> {
    override readonly translations: OnboardingScoreComparisonStrings = {
        ...
        scoreComparisonConstraint:
            "This feature is accessible via the </compare:881018535978074173> command. This only works if there is a conversation regarding a score or beatmap. Additionally, the score must be submitted to the server, which requires an osu!droid account.",
        ...
        compareCommandExplanation:
            "The </compare:881018535978074173> command can be used to compare any scores from any player with additional information if available, such as pp obtained, hit error, and unstable rate (UR).",
        accountBindConvenienceQuote:
            'The </compare:881018535978074173> command is more convenient to use if you bind your osu!droid account to Discord account. For more information, please refer to the "Bind osu!droid account" button in the first introduction menu.',
    };
}
