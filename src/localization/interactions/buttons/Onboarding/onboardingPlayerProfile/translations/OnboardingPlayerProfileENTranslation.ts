...
export class OnboardingPlayerProfileENTranslation extends Translation<OnboardingPlayerProfileStrings> {
    override readonly translations: OnboardingPlayerProfileStrings = {
        ...
        playerProfileIntroduction:
            'Easily show or share your profile with other players with this feature. This is accessible via the </profile view:881019145267859536> command and the "View osu!droid Profile" button in the apps menu.',
        ...
        profileCommandExplanation:
            "The </profile view:881019145267859536> will display the profile card of a player (by default it's yourself). Options can be used to display the profile card of another player.",
