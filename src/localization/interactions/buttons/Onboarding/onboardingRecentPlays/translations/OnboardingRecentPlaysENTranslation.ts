...
export class OnboardingRecentPlaysENTranslation extends Translation<OnboardingRecentPlaysStrings> {
    override readonly translations: OnboardingRecentPlaysStrings = {
        ...
        recentPlaysIntroduction:
            'One of the most commonly used feature of mine is showing a player\'s recent plays. This is accessible via the </recent:881019169603223584> and </recent5:881019186137169970> commands as well as the "View Recent Plays" button accessible in the apps menu. These commands can only display plays that were submitted to the server, which requires you to have an osu!droid account.',
