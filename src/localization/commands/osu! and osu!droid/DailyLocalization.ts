...
export class DailyLocalization extends Localization<DailyStrings> {
    ...
    > = {
            en: {
                ...
                aboutAnswer2: "There will be a separate beatmap set for you to download in case you have played the original map. In fact, you **must** download the set in order to submit your play.\n\nOnce you complete a challenge, use the `/daily submit` command to submit your play.",
