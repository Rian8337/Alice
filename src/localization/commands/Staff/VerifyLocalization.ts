...
export class VerifyLocalization extends Localization<VerifyStrings> {
    protected override readonly translations: Readonly<Translation<VerifyStrings>> = {
        en: {
            commandNotAvailableInChannel: "I'm sorry, this command cannot be used in this channel.",
