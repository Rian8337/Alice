...
export class ConstantsKRTranslation extends Translation<ConstantsStrings> {
    override readonly translations: ConstantsStrings = {
        ...
        selfAccountNotBinded:
            "죄송해요, 당신의 계정은 바인딩 되어있지 않아요. 먼저 </userbind username:881019231863468083>로 계정을 바인드 해야해요.",
        ...
        userAccountNotBinded:
            "죄송해요, 해당 계정은 바인드되어있지 않아요. 그 유저는 먼저 </userbind username:881019231863468083>로 계정을 바인드 해야해요.",
    };
}
