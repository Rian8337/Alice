...
export class CuteNoLewdLocalization extends Localization<CuteNoLewdStrings> {
    protected override readonly translations: Readonly<Translation<CuteNoLewdStrings>> = {
        en: {
            imageSentTooFast: "%s, you are only allowed to send 1 picture every 5 seconds!",
        }
    };
}