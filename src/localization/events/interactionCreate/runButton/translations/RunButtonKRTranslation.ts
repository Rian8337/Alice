...
/**
 * The Korean translation for the `runButton` event utility for `interactionCreate` event.
 */
export class RunButtonKRTranslation extends Translation<RunButtonStrings> {
