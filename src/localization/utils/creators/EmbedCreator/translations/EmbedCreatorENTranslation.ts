...
export class EmbedCreatorENTranslation extends Translation<EmbedCreatorStrings> {
    override readonly translations: EmbedCreatorStrings = {
        ...
        multiplayerRoomHost: "Host",
        multiplayerRoomPassword: "Password",
        multiplayerRoomPlayerCount: "Players",
        multiplayerRoomCurrentBeatmap: "Current Beatmap",
        multiplayerRoomSettings: "Settings",
        multiplayerRoomTeamMode: "Team Mode",
        multiplayerRoomWinCondition: "Win Condition",
        multiplayerRoomAllowSliderLock: "Allow Slider Lock",
        multiplayerRoomAllowedMods: "Allowed Mods",
        multiplayerRoomRequiredMods: "Required Mods",
        multiplayerRoomResults: "Results",
        multiplayerWon: "%s won",
        multiplayerDraw: "It's a draw",
        multiplayerTotalScore: "Total",
        multiplayerRedTeam: "Red Team",
        multiplayerBlueTeam: "Blue Team",
    };
}
