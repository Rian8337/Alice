...
export class DroidPerformanceCalculator extends PerformanceCalculator {
    ...
    calculate(params: {
        ...
        // high tap value (which is easily abusable by using more than 2 fingers).
        // let extremePenalty = Math.pow(
        //     1 - Math.abs(this.tap - Math.pow(this.aim, 1.05)) /
        //     Math.max(this.tap, Math.pow(this.aim, 1.05)),
        //     0.2
        // );
